...
[
    [ "Overview of Examples&Tutorials", "example_tutorial_projects.html#jkqtp_extut", [
      ...
      [ "Image data Plots", "example_tutorial_projects.html#jkqtp_extut_plotimagedata", null ],
      [ "GUI Tools", "example_tutorial_projects.html#jkqtp_extut_guitools", null ],
    ...
    [ "Example (JKQTPlotter): Step Line Plots in Different Styles", "_j_k_q_t_plotter_special_step_line_plot.html", null ],
    [ "Example (JKQTPlotter): Simple line-graph with error bars", "_j_k_q_t_plotter_symbols_errors.html", null ],
    [ "Example (JKQTPlotter): Different Types of Errorindicators", "_j_k_q_t_plotter_error_bar_styles.html", null ],
    ...
    [ "Example (JKQTPlotter): Plotting Parametric Mathematical Curves as Line Graphs", "_j_k_q_t_plotter_eval_curves.html", [
      ...
      [ "Simple C++ inline function", "_j_k_q_t_plotter_eval_curves.html#autotoc_md65", null ],
      [ "Simple C++ inline function with Parameters", "_j_k_q_t_plotter_eval_curves.html#autotoc_md66", null ],
      [ "Screenshot", "_j_k_q_t_plotter_eval_curves.html#autotoc_md67", null ],
      [ "Notes", "_j_k_q_t_plotter_eval_curves.html#autotoc_md68", null ]
    ] ],
    ...
    [ "Example (JKQTPlotter): Simple Math RGB/CMY Image Plot", "_j_k_q_t_plotter_r_g_b_image_plot.html", null ],
    [ "Example (JKQTPlotter): Simple math image plot, showin a 1-channel OpenCV cv::Mat", "_j_k_q_t_plotter_image_plot_open_c_v.html", null ],
    [ "Example (JKQTPlotter): Simple RGB image plot, showing a 3-channel OpenCV cv::Mat", "_j_k_q_t_plotter_image_plot_r_g_b_open_c_v.html", null ],
    [ "Example (JKQTPlotter): Simple math image plot, showin a 1-channel CImg image", "_j_k_q_t_plotter_image_plot_c_img.html", null ],
    [ "Example (JKQTPlotter): Simple math image plot, showing a 3-channel CImg image", "_j_k_q_t_plotter_image_plot_r_g_b_c_img.html", null ],
    [ "Example (JKQTPlotter): Contour Plots", "_j_k_q_t_plotter_contour_plot.html", [
      [ "Drawing a Contour Plot", "_j_k_q_t_plotter_contour_plot.html#autotoc_md13", null ],
      [ "Styling a Contour Plot", "_j_k_q_t_plotter_contour_plot.html#autotoc_md14", null ],
      [ "Gimmick: Animating a Contour Plot", "_j_k_q_t_plotter_contour_plot.html#autotoc_md15", null ]
    ] ],
    [ "Tutorial (JKQTPlotter): Using a JKQTPlotter inside a Qt User Interface Designer (UI) File", "_j_k_q_t_plotter_qt_creator.html", [
      [ "Instructions on how to use JKQTPlotter in the Qt Form Designer", "_j_k_q_t_plotter_qt_creator.html#autotoc_md94", null ],
      [ "QMake-Project of this example", "_j_k_q_t_plotter_qt_creator.html#autotoc_md95", null ],
      [ "Form Class <tt>FormWithJKQTPlotter</tt>", "_j_k_q_t_plotter_qt_creator.html#autotoc_md96", null ]
    ] ],
    [ "Tutorial (JKQTPlotter): User-Interactions in JKQtPlotter", "_j_k_q_t_plotter_user_interaction.html", [
      [ "Basic Description", "_j_k_q_t_plotter_user_interaction.html#autotoc_md97", null ],
      [ "Inner Workings", "_j_k_q_t_plotter_user_interaction.html#autotoc_md98", null ],
      [ "Available User-Interactions", "_j_k_q_t_plotter_user_interaction.html#autotoc_md99", [
        [ "Switching Graph Visibility via Context Menu", "_j_k_q_t_plotter_user_interaction.html#autotoc_md100", null ],
    ...
    [ "Tutorial (JKQTPDatastore): Iterator-Based usage of JKQTPDatastore", "_j_k_q_t_plotter_basic_j_k_q_t_p_datastore_iterators.html", [
      ...
      [ "Back-Inserter for Columns", "_j_k_q_t_plotter_basic_j_k_q_t_p_datastore_iterators.html#autotoc_md39", null ],
      [ "Using C++ STL algorithms", "_j_k_q_t_plotter_basic_j_k_q_t_p_datastore_iterators.html#autotoc_md40", null ],
    ...
    [ "Tutorial (JKQTPDatastore): Regression Analysis (with the Statistics Library)", "_j_k_q_t_plotter_basic_j_k_q_t_p_datastore_regression.html", [
      ...
      [ "Robust Linear Regression", "_j_k_q_t_plotter_basic_j_k_q_t_p_datastore_regression.html#autotoc_md43", null ],
      [ "Weighted Linear Regression", "_j_k_q_t_plotter_basic_j_k_q_t_p_datastore_regression.html#autotoc_md44", null ],
      [ "Linearizable Regression Models", "_j_k_q_t_plotter_basic_j_k_q_t_p_datastore_regression.html#autotoc_md45", null ],
      [ "Polynom Fitting", "_j_k_q_t_plotter_basic_j_k_q_t_p_datastore_regression.html#autotoc_md46", null ],
